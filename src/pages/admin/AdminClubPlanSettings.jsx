    ...
    <section className="admin-club-plan" aria-labelledby="admin-club-plan-title">
      ...
      <div className="admin-club-plan__card">
        ...
        <p className="muted admin-club-plan__card-lead">
          Считаются завершённые тренировки персонального зала за календарный месяц по картам с оплатой
          тренеру (ставки в «Типы абон.»). Карты с оплатой 0 ₽ в план не входят. Без плана у сотрудника
          позже всегда будет уровень 3 — это в кабинете сотрудника.
        </p>
