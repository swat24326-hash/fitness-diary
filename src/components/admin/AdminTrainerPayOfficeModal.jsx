    ...
    >
      <div className="modal-panel admin-trainer-pay-office" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="muted" style={{ margin: '0 0 12px', lineHeight: 1.45 }}>
          <strong>{trainer?.name ?? 'Тренер'}</strong>. План — уровни по числу тренировок месяца по типам с
          галочкой «В план» (пороги в «План ЗП»; настраивается в «Типы абон.»). Без плана — всегда уровень 3.
          Надбавка/минус — к ставке <em>каждой</em> тренировки, но не к картам с оплатой 0 ₽ (там ставка
          остаётся 0).
        </p>
