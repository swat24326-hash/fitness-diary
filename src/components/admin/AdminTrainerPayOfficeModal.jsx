    ...
    >
      <div className="modal-panel admin-trainer-pay-office" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="muted" style={{ margin: '0 0 12px', lineHeight: 1.45 }}>
          <strong>{trainer?.name ?? 'Тренер'}</strong>. План — уровни по числу тренировок месяца по картам с
          оплатой &gt; 0 ₽ (пороги в «План ЗП»; нулевые карты в план не входят). Без плана — всегда уровень 3.
