 ...
 * Убирает самопрезентацию с повтором имени; добавляет переход и напоминание.
...
export function normalizeIskraOffTopicReply(text, clubName = '', userMessage = '') {
 ...
 * Подсказка в user-message для Gemini: только факт, хвост допишет система.
...
export function buildIskraQuestionReplyHint(message, _clubName = '') {
