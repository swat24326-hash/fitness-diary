...
export function buildGeminiDataSourceRules() {
  return [
    ...
    'structure_shares — доли НК/ДК/УК/доп. продаж в выручке (%), уже посчитаны в insights.structure.',
    'direction_structure — направления ПЗ/ТЗ/АЗ/доп.: факт ₽, доля %, plan_progress_pct — выполнение плана по направлениям.',
    ...
    'insights.issues — отсортированные проблемы месяца; top_issue — главная. Если has_critical_issues=false — явных дыр нет.',
