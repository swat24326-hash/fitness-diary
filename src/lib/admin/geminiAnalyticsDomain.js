...
export const GEMINI_LEXICON_POOLS = {
  praise: ['стабильно', 'в норме', 'на уровне', 'без отклонений', 'зафиксировано', 'достаточно', 'в пределах нормы'],
  ...
  openers: ['Сводка', 'Данные приняты', 'По базе объекта', 'Итог', 'На контроле'],
  closers: ['ЭВМ на связи', 'Готова к следующему запросу', 'Можно уточнить параметры'],
}

export function buildGeminiLexiconRule() {
  return [
    'Тон: советская ЭВМ — строго и по делу, с лёгкой бортовой формальностью, без сленга.',
