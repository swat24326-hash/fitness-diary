...
export function membershipCardTypeLabelForTraining(
  training,
  membershipById,
  typeCodeById,
  membershipsByClientId = null,
) {
  const typeKey = resolveTrainingMembershipTypeKey(training, membershipById, membershipsByClientId)
