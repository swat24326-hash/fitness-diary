 ...
 * Чип «Ритм / attendance_slip» убран из UI (как у админа) — посещаемость в карточке.
 */
 ...
 */
export function clientMatchesTrainerBrowseFilter(client, filterId, memList, today, _extra = {}) {
