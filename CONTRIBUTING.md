...
Короткий вход для человека без Cursor. Политика агента — `.cursor/rules/`; карта продукта — [docs/PROJECT_HANDOFF_FOR_AI.md](./docs/PROJECT_HANDOFF_FOR_AI.md).

## Перед кодом

1. Прочитать handoff и нужный раздел [docs/README.md](./docs/README.md).
...
- Prod: см. [docs/RELEASE.md](./docs/RELEASE.md). Инциденты: [docs/RUNBOOK.md](./docs/RUNBOOK.md).
