...
**Актуально:** 2026-07-18. Документ самодостаточен: по нему можно продолжить работу без истории чата. Язык UI — **русский**. Репозиторий: **fitness-diary** (PWA дневник тренировок, бренд — FIT-CITY).
...
**Качество ведения** (care / depth / хвосты ДК+БЗ): [COACH_QUALITY.md](./COACH_QUALITY.md) — блок в статистике клуба и у тренера.
