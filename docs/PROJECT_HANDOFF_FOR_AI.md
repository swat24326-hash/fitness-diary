...
**Актуально:** 2026-07-19. Документ самодостаточен: по нему можно продолжить работу без истории чата. Язык UI — **русский**. Репозиторий: **fitness-diary** (бренд — FIT-CITY).
