...
**Плитки на экране Клиенты** («Все клиенты», воронка абона) — счётчики **текущей вкладки**; клик = та же длина списка (в т.ч. holding на «Не назначен» во «Все» и в воронке). Сводка дня на главной = та же вкладка ПЗ.
