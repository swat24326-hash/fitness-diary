...
**Плитки на экране Клиенты** («Все клиенты», воронка абона) — счётчики **текущей вкладки**; клик = та же длина списка. Клубной commercial/operational census — только **Статистика / сводка дня**, не подмена плитки «Все».
