...
**Плитки на экране Клиенты** («Все клиенты», воронка абона) — счётчики **текущей вкладки**; клик = та же длина списка. На **ПЗ** воронка = commercial (без holding «Не назначен» и desk) — как сводка дня на главной.
