...
**Актуально:** 2026-08-08. Крупная цель продукта — [PRODUCT_VISION.md](./PRODUCT_VISION.md). Нарезка сейчас→дальше — [PATH_TO_GOAL.md](./PATH_TO_GOAL.md). Ядро (клиент / абонемент / тренировка / sync) — handoff и [DATA_MODEL.md](./DATA_MODEL.md). Здесь — соседние контуры, чтобы не искать по репо вслепую.
