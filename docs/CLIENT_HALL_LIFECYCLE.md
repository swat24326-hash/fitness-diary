...
| Кто | UI |
|-----|-----|
| Тренер | **Активные \| Закрытые**; «Закрыть ПЗ» / «Снова ко мне»; метка «есть ТЗ/АЗ» или «архив клуба» |
| Админ / менеджер | **ПЗ \| ТЗ \| АЗ \| Архив**; внутри зала **Живые \| Закрытые**; «Ушёл из клуба»; «Вернуть в клуб» |
