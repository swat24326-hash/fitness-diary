...
Массовый автообзвон; кнопка SMS/звонка у тренера; отметка «звонили» на строке доски. Запись разговора — ссылка в кабинете Мои Звонки (в журнал Оси пока не тянем).
