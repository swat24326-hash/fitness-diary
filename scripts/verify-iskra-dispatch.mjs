...
ok(canCreateClubDispatch({ isSupervisor: true, user: { club_id: 'c1' } }, 'c1'), 'supervisor own club')
ok(!canCreateClubDispatch({ isSupervisor: true, user: { club_id: 'c1' } }, 'c2'), 'supervisor other club blocked')
ok(canViewClubDispatchSent({ isSupervisor: true }), 'supervisor can view sent')
