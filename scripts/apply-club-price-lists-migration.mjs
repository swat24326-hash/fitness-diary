/**
 * Применить миграцию club_price_lists.
 *   npm run db:migrate:price-list -- --linked
 */
import { spawnSync } from 'node:child_process'
import { existsSync, readFileSync } from 'node:fs'
import { resolve } from 'node:path'

const MIGRATION = 'supabase/migrations/20260730120000_club_price_lists.sql'
const VERIFY_SQL =
  "select table_name from information_schema.tables where table_schema='public' and table_name = 'club_price_lists';"
...
console.log('\nМиграция club_price_lists применена.')
