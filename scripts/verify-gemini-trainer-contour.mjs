...
ok(contour.selected_trainer?.no_type_trainings_ignored === 1, 'no type ignored')
ok(contour.selected_trainer?.personal_salary_month === 1000, 'personal salary tr1')
ok(contour.club_roll_up.trainers_count === 2, 'club roll up count')
ok(contour.club_roll_up.personal_salary_sum === 1500, 'club salary sum')
