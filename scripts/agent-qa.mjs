...
run('training new draft date', 'node', ['scripts/verify-training-new-draft-date.mjs'])
...
run('club finance matrix reconcile', 'node', ['scripts/verify-club-finance-matrix-reconcile.mjs'])
...
run('sales plan forecast parity', 'node', ['scripts/verify-sales-plan-forecast-parity.mjs'])
...
run('pnk post training edge', 'node', ['scripts/verify-pnk-post-training-edge.mjs'])
run('pnk coach tab sync', 'node', ['scripts/verify-pnk-coach-tab-sync.mjs'])
...
run('training draft tab switch', 'node', ['scripts/verify-training-draft-tab-switch.mjs'])
run('training health gate', 'node', ['scripts/verify-training-health-gate.mjs'])
...
run('code trace doc', 'node', ['scripts/verify-code-trace.mjs'])
...
run('trainer pull response', 'node', ['scripts/verify-trainer-pull-response.mjs'])
...
run('client attendance stats', 'node', ['scripts/verify-client-attendance-stats.mjs'])
run('client attendance glance', 'node', ['scripts/verify-client-attendance-glance.mjs'])
run('club attendance agg', 'node', ['scripts/verify-club-attendance-agg.mjs'])
...
run('homework share', 'node', ['scripts/verify-homework-share.mjs'])
